...
There are 134 aisles in the dataset. The most items are ordered from the produce aisles (fresha and packaged vegetables and fruits).
...
![](p8105_hw3_amv2187_files/figure-markdown_github/unnamed-chunk-10-1.png)
